def call() {    
    sshPublisher(publishers: [sshPublisherDesc(configName: 'localhost', sshCredentials: [encryptedPassphrase: '{AQAAABAAAAAQkMeyfvLn1dSSUCd5D3xnXqdu6hxK77+YLyz5vqXV8c8=}', 
